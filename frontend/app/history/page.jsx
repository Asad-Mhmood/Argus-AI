...
export default function HistoryPage() {
  ...
  return (
    <>
      ...
      <p className="page-sub">Every detection across all sessions, searchable and exportable.</p>
      ...
      <div className="toolbar">
        ...
        <div>
          ...
          <select id="uc" className="select" value={useCase} onChange={(e) => setUseCase(e.target.value)}>
        ...
        {events.length === 0 ? (
          ...
          <div className="table-wrap">
            <table className="data">
              <thead>
                <tr><th>Time</th><th>Use case</th><th>Event</th><th>Label</th><th>Confidence</th></tr>
              </thead>
              <tbody>
                {events.map((e) => (
                  <tr key={e.id}>
