...
export default function AttendancePage() {
  ...
  return (
    <>
      ...
      <p className="page-sub">Who was recognized, when they arrived, and every unknown face — across all sessions.</p>
      ...
      <div className="grid" style={{ gridTemplateColumns: "minmax(0, 7fr) minmax(0, 5fr)", alignItems: "start" }}>
        ...
        <div className="card">
          ...
          <p className="muted" style={{ marginTop: 10 }}>
            ...
            Enroll them on the People page to start tracking their attendance.
          </p>
        </div>
      </div>
    </>
